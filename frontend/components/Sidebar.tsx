        ...
        <div className="w-64 fixed inset-y-0 left-0 bg-slate-900 border-r border-slate-800 flex flex-col z-50 transition-all duration-300">
            <div className="p-8 pb-4">
                <div className="flex items-center gap-3 mb-1">
                    ...
                    <h1 className="text-xl font-bold text-white tracking-tight">AutoForm</h1>
                </div>
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest pl-11">Pro Agent</p>
            </div>
